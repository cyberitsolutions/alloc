...
INSERT INTO permission (tableName, entityID, personID, roleName, allow, sortKey, comment, actions, permissionID) VALUES ('commentTemplate',0,0,'manage','Y',NULL,'To let project managers manipulate task comment templates.',15,99);
...
INSERT INTO permission (tableName, entityID, personID, roleName, allow, sortKey, comment, actions, permissionID) VALUES ('commentTemplate',0,0,'','Y',NULL,'Allow everyone to read commentTemplates',1,109);

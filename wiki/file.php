...
if ($_POST["save"]) {
    ...
    if ($errors) {
        ...
        if (is_object($vcs)) {
            ...
            } elseif ($file && $editName && $editName != $file) {
...
} elseif ($file && is_file(wiki_module::get_wiki_path().$file) && is_readable(wiki_module::get_wiki_path().$file)) {

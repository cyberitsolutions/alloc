...
class wiki_module extends module
{
    ...
    {
        // for some reason trailing slashes on a line appear to not get saved
        // by particular vcs's. So when we compare the two files (the one on
        // disk and the one in version control, we need to nuke trailing

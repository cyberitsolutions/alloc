...
class vcs
{
    ...
    public function juggle_command_order($name, $command, $repo)
    {
    ...
    public function commit($file, $message = false)
    {
    ...
    public function cat($file, $revision)
    {
    ...
    public function format_log($logs = array())
    {
        /*
        ...
        */
        ...
        foreach ($logs as $line) {
            ...
            } elseif (preg_match("/^Msg: (.+$)/", $line, $matches)) {

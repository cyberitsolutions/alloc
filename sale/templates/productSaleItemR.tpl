<tr id="productSaleItemRow{$productSaleItemID}" style="{$display}">
  ...
  <td><input type="text" size="10" name="buyCost[]" value="{$buyCost}"> <label name="costCurrency">{$buyCostCurrencyTypeID}</label>{$buyCostTax_check}</td>
  ...
  <td class="right nobr">
    ...
    <input type="hidden" name="buyCostCurrencyTypeID[]" value="{$buyCostCurrencyTypeID}">

...
if (!$current_user->prefs["productSaleList_filter"]) {
    $TPL["message_help"][] = "allocPSA allows you to create Sales and Products
    and allocate the funds from Sales. This page allows you to view a list of
    Sales.
    <br><br>
    Simply adjust the filter settings and click the <b>Filter</b> button to
    display a list of previously created Sales. If you would prefer to create a
    new Sale, click the <b>New Sale</b> link in the top-right hand corner of
    the box below.";
}

...
// Will log emails sent, and will not attempt to send email when the server is
// a dev boxes
class email_send
{
    ...
    public function log()
    {
        ...
        $sentEmailLog->set_value("sentEmailBody", substr($this->body_without_attachments, 0, 65000));

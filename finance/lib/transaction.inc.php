...
class transaction extends db_entity
{
    ...
    public function get_transaction_type_link()
    {
        ...
        // Had to rewrite this so that people who had transactions on other
        // peoples timesheets could see their own transactions, but not the
        // other persons timesheet.
    ...
    public static function get_list($_FORM)
    {
        ...
        // This is the definitive method of getting a list of transactions
        // that need a sophisticated level of filtering
    ...
    public function load_transaction_filter($_FORM)
    {
        ...
        // Fiddle $_FORM["monthDate"]. It may be a real date (2010-11-23) so
        // change the last 2 chars to "01".

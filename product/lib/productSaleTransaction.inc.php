...
class productSaleTransaction extends db_entity {
  var $classname = "productSaleTransaction";
  var $data_table = "productSaleTransaction";

  function productSaleTransaction() {
    $this->db_entity();         // Call constructor of parent class
    $this->key_field = new db_field("productSaleTransactionID");

...
class task extends db_entity
{
    ...
    public function save()
    {
        ...
        if ($errors) {
            ...
            if ($existing["taskStatus"] != $this->get_value("taskStatus")) {
                ...
                // Unfortunately the call to save() below erroneously nukes
                // these fields.  So we manually set them to whatever
                // change_task_status() has dictated.
    ...
    public function add_reopen_reminder($date)
    {
        ...
        // Allows the form to be saved without changing anything the 8:30 is
        // the same as creation, below.
        if ($date) {
    ...
    public function set_option_tpl_values()
    {
        ...
        // We're building these two with the <select> tags because they will
        // be replaced by an AJAX created dropdown when the projectID changes.
    ...
    public static function get_list($_FORM)
    {
        ...
        // This is the definitive method of getting a list of tasks that need

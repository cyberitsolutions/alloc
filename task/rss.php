...
// create an artifical sort key. Creation/audit date is not unique, and
// creation should come before any status changes.
...
// create a character (&amp;, &lt;, etc). SimpleXML doesn't escape it,
// probably for that reason. There should be no HTML in task titles so this
// should be safe.
...
while ($row = $db->next_record()) {
    ...
    // overwrite the new data (taskStatus, personID) with the correct
    // (historical) data
    if ($trace[$row['taskID']]) {

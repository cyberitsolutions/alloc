...
function get_pending_timesheet_db()
{
    ...
    */
    ...
    // Get all the time sheets that are in status manager, and are the
    // responsibility of only the default manager
    ...
    // Get all the time sheets that are in status manager, where the currently
    // logged in user is the manager
    } else {
        $query = prepare(

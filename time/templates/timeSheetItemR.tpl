...
<tr>
  ...
  <td valign="top" width="30%">{$timeSheetItem_timeSheetItemDuration} {$unit} @ ${$timeSheetItem_rate} x {$timeSheetItem_multiplier}</td>
  <td valign="top" width="10%"><b>${$timeSheetItem_unit_times_rate}</b></td>

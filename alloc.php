...
// The order of file processing usually goes: requested_script.php ->
// alloc.php -> alloc_config.php -> more includes -> back to
// requested_script.php
...
define("SRC_DATABASE", 1);
// Reading the value from a PHP variable (except a form variable)
define("SRC_VARIABLE", 2);
// Reading the value from a get or post variable
define("SRC_REQUEST", 3);
// For writing to a database
define("DST_DATABASE", 1);
// For use within the PHP script itself
define("DST_VARIABLE", 2);
// For display to the user as non-editable HTML text
define("DST_HTML_DISPLAY", 4);
...
// Else include the alloc_config.php file and begin with proceedings..
    ...
    // The timezone must be dealt with before anything else uses it or php
    // will emit a warning
...
// This is a hook for the SaaS side of alloc, to allow per-site code
// customizations

...
if (!$current_user->prefs["projectList_filter"]) {
    $TPL["message_help"][] = "allocPSA helps you manage Projects. This page
    allows you to see a list of Projects.
    <br><br>
    Simply adjust the filter settings and click the <b>Filter</b> button to
    display a list of previously created Projects. If you would prefer to
    create a new Project, click the <b>New Project</b> link in the top-right

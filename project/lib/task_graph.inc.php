...
class task_graph
{
    ...
    public $task_colors;
    // image height - set dynamically according to number of tasks and other
    // variables such as bar_height
    public $height;
    ...
    public $color_today;
    // Milestones are stored and then drawn over the top of the tasks
    public $milestones = array();

    public function init($tasks = array())
    {

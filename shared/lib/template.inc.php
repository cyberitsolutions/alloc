...
// variables and javascript/css syntax playing together nicely. Basically
...
// array. $var can also be html entity protected if prefixed with the equals
// sign.
...
function get_template($filename)
{
    ...
    // This allows us to use curly braces in our templates for javascript and
    // CSS rules The TPL_*_BRACE keyword gets replaces by an actual curly
    // brace later on in this template function. Uis means: ungreedy,
    // case-insensitive and include newlines for dot matches.

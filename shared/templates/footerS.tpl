{$extra_footer_stuff}
    ...
    <div id="slowest_query_1" style="text-align:right; font-size:70%;" class="faint">
      {print_expand_link("slowest_query_2", $slowest_query_time, "slowest_query_1")}
    </div>
    <div id="slowest_query_2" style="text-align:right; font-size:70%; display:none" class="faint">
      Slowest page query {print_expand_link("slowest_query_2", $slowest_query_time, "slowest_query_1")}

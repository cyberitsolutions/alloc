...
--  insert into config (name,value) values ('companyACN','053 904 082');
...
--  In other words the script will add a new projectPersonCommission entry for each project where there is an externally billed 
--  rate and the is a time sheet recipient set. 

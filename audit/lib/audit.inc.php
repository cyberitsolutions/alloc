...
class audit extends db_entity
{
    ...
    public $data_fields = array('auditID', 'taskID', 'projectID', 'personID', 'dateChanged', 'field', 'value',
                             );
    ...
    $filter = self::get_list_filter($_FORM);
    ...
    {
        return array('taskID' => 'The task id to find audit records for', 'projectID' => 'The project id to find audit records for',
                );
    }
}
